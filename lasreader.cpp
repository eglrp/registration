...
#include "las/laspointreader0raw.h"
#include "las/laspointreader1raw.h"
#include "las/laspointreader2raw.h"
#include "las/laspointreader3raw.h"

#ifdef ENABLE_LAS_COMPRESSION
#include "las/laspointreader0compressed.h"
#include "las/laspointreader1compressed.h"
#include "las/laspointreader2compressed.h"
#include "las/laspointreader3compressed.h"
#include "las/laspointreader0compressedarithmetic.h"
#include "las/laspointreader1compressedarithmetic.h"
#include "las/laspointreader2compressedarithmetic.h"
#include "las/laspointreader3compressedarithmetic.h"
...
bool LASreader::open(FILE *file, bool skip_all_headers)
{
  ...
  if (header.x_scale_factor == 0 || header.y_scale_factor == 0 || header.z_scale_factor == 0)
  {
    ...
    if (header.x_scale_factor == 0)
      header.x_scale_factor = 0.01;
    if (header.y_scale_factor == 0)
      header.y_scale_factor = 0.01;
    if (header.z_scale_factor == 0)
